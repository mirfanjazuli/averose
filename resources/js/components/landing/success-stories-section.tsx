    ...
    return (
        ...
        >
            <div className="mx-auto max-w-7xl px-4 sm:px-8 lg:px-10">
                <div className="overflow-hidden rounded-[2rem] bg-[#102a3a] px-5 py-10 text-white shadow-xl shadow-[#102a3a]/10 sm:rounded-[2.5rem] sm:px-10 sm:py-12 lg:px-14">
                    <div className="grid items-end gap-7 lg:grid-cols-[1fr_auto]">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="max-w-28 text-sm leading-5 text-white/70">
                    ...
                    <div className="mt-8 grid gap-4 sm:mt-10 lg:grid-cols-3">
                        {testimonials.map((testimonial) => (
                            <article
                                ...
                                className="rounded-[1.5rem] bg-white p-5 text-[#102a3a] sm:rounded-[1.75rem] sm:p-6"
                            >
                                ...
                                <p className="mt-5 text-sm leading-6 text-[#526b7b]">
                                    “{testimonial.quote}”
                                </p>
                                <div className="mt-6 flex items-center gap-3 border-t pt-5">
                                    <span className="flex size-11 shrink-0 items-center justify-center rounded-full bg-[#e4f5f0] text-sm font-bold text-[#0f8f7a]">
                                    ...
                                    <span>
                                        ...
                                        <span className="block text-xs text-[#647987]">
                                            {testimonial.school}
                                        </span>
                                    </span>
                                </div>
