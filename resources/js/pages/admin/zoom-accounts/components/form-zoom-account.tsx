...
type FormZoomAccountProps = {
    account?: ZoomAccountFormAccount;
    errors: Partial<Record<string, string>>;
    idPrefix: string;
};

export function FormZoomAccount({
    account,
    errors,
    idPrefix,
}: FormZoomAccountProps) {
    ...
    return (
        <>
            ...
            <div className="grid gap-2">
                <Label htmlFor={`${idPrefix}-account-id`}>Account ID</Label>
                <Input
            ...
            <div className="grid gap-2">
                <Label htmlFor={`${idPrefix}-token-secret`}>Token Secret</Label>
                <PasswordInput
